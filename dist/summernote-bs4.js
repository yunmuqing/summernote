...
(function (global, factory) {
   ...
   */
  function createImage(url,link,open_in_new_window) {
      return $$1.Deferred(function (deferred) {
          var $img = $$1('<img>');
  ...
  */
  ...
  var Editor = /** @class */ (function () {
      ...
      */
       ...
       * @return {Promise}
       */
      Editor.prototype.insertImage = function (src,link,open_in_new_window, param) {
          var _this = this;
          return createImage(src,link,open_in_new_window, param).then(function ($image) {
              _this.beforeCommand();
              console.log($image[0])
              if (typeof param === 'function') {
                  ...
                  $image.css('width', Math.min(_this.$editable.width(), $image[0].width));
              }
              $image.show();
              link = $('.note-image-link').val();
              console.log(link)
              if ( link != '') {
                ...
                if ($('.sn_checkbox_open_in_new_window input[type=checkbox]').is(':checked')) {
                  $image = $$1(`<a href="${link}" target="_blank">${$image[0].outerHTML}</a>`);
                }else{
                  $image = $$1(`<a href="${link}">${$image[0].outerHTML}</a>`);
                }
              }else{
                $image = $$1(`${$image[0].outerHTML}`);
              }
      ...
      Editor.prototype.getLinkInfo = function () {
        ...
        if (this.getLastRange().sc.innerHTML) {
          console.log(this.getLastRange().sc.innerHTML.indexOf("<img"))
          if(this.getLastRange().sc.innerHTML.indexOf("<img") == 0){
              var rng_text = this.getLastRange().sc.innerHTML;
          }else{
              var rng_text = rng.toString();
          }    
  ...
  var ImageDialog = /** @class */ (function () {
      ...
      ImageDialog.prototype.initialize = function () {
          ...
          var body = [
              ...
              ' col-md-12" type="text" />',
              '</div>',
              '<div class="form-group note-group-image-link" style="overflow:auto;">',
              '<label class="note-form-label">' + this.lang.image.link + '</label>',
              '<input class="note-image-link form-control note-form-control note-input ',
              ' col-md-12" type="text" />',
              '</div>',
              '<div class="form-check sn_checkbox_open_in_new_window"><label class="form-check-label"> <input role="checkbox" type="checkbox" class="form-check-input open_in_new_window" checked="" aria-label="Open in new window" aria-checked="true"> Open in new window</label></div>',
          ].join('');
      ...
      ImageDialog.prototype.show = function () {
          var _this = this;
          this.context.invoke('editor.saveRange');
          this.showImageDialog().then(function (data,link,open_in_new_window) {
              ...
              if (typeof data === 'string') { // image url
                  ...
                  if (_this.options.callbacks.onImageLinkInsert) {
                      ...
                      _this.context.invoke('editor.insertImage', data,link,open_in_new_window);
                  }
              }
              else { // array of files
      ...
      ImageDialog.prototype.showImageDialog = function () {
          ...
          return $$1.Deferred(function (deferred) {
              ...
              var $imageLink = _this.$dialog.find('.note-image-link');
              var $open_in_new_window = _this.$dialog.find('.open_in_new_window');
              ...
              _this.ui.onDialogShown(_this.$dialog, function () {
                  ...
                  $imageBtn.click(function (event) {
                      event.preventDefault();
                      deferred.resolve($imageUrl.val(),$imageLink.val(),$open_in_new_window.val());
                  });
